...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_main_ada_string_processing" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#1049e019#;
   pragma Export (C, u00001, "main_ada_string_processingB");
   ...
   u00167 : constant Version_32 := 16#b5988c27#;
   pragma Export (C, u00167, "gnatS");
   u00168 : constant Version_32 := 16#dbf24c7a#;
   pragma Export (C, u00168, "gnat__string_splitB");
   u00169 : constant Version_32 := 16#3d848bbe#;
   pragma Export (C, u00169, "gnat__string_splitS");
   u00170 : constant Version_32 := 16#75eb9fdd#;
   pragma Export (C, u00170, "pkg_ada_dtstampB");
   u00171 : constant Version_32 := 16#738280fa#;
   pragma Export (C, u00171, "pkg_ada_dtstampS");
   u00172 : constant Version_32 := 16#9a2e29aa#;
   pragma Export (C, u00172, "ada__calendarB");
   u00173 : constant Version_32 := 16#c4f07049#;
   pragma Export (C, u00173, "ada__calendarS");
   u00174 : constant Version_32 := 16#10f667b3#;
   pragma Export (C, u00174, "ada__calendar__formattingB");
   u00175 : constant Version_32 := 16#f87a094f#;
   pragma Export (C, u00175, "ada__calendar__formattingS");
   u00176 : constant Version_32 := 16#e3cca715#;
   pragma Export (C, u00176, "ada__calendar__time_zonesB");
   u00177 : constant Version_32 := 16#f21593b3#;
   pragma Export (C, u00177, "ada__calendar__time_zonesS");
   u00178 : constant Version_32 := 16#d763507a#;
   pragma Export (C, u00178, "system__val_intB");
   u00179 : constant Version_32 := 16#0e90c63b#;
   pragma Export (C, u00179, "system__val_intS");
   u00180 : constant Version_32 := 16#1d9142a4#;
   pragma Export (C, u00180, "system__val_unsB");
   u00181 : constant Version_32 := 16#621b7dbc#;
   pragma Export (C, u00181, "system__val_unsS");
   u00182 : constant Version_32 := 16#c2ca0511#;
   pragma Export (C, u00182, "system__val_realB");
   u00183 : constant Version_32 := 16#b81c9b15#;
   pragma Export (C, u00183, "system__val_realS");
   u00184 : constant Version_32 := 16#b2a569d2#;
   pragma Export (C, u00184, "system__exn_llfB");
   u00185 : constant Version_32 := 16#fa4b57d8#;
   pragma Export (C, u00185, "system__exn_llfS");
   u00186 : constant Version_32 := 16#42a257f7#;
   pragma Export (C, u00186, "system__fat_llfS");
   u00187 : constant Version_32 := 16#1b28662b#;
   pragma Export (C, u00187, "system__float_controlB");
   u00188 : constant Version_32 := 16#a6c9af38#;
   pragma Export (C, u00188, "system__float_controlS");
   u00189 : constant Version_32 := 16#16458a73#;
   pragma Export (C, u00189, "system__powten_tableS");
   u00190 : constant Version_32 := 16#4fc9bc76#;
   pragma Export (C, u00190, "ada__command_lineB");
   u00191 : constant Version_32 := 16#3cdef8c9#;
   pragma Export (C, u00191, "ada__command_lineS");
   u00192 : constant Version_32 := 16#2353cf5b#;
   pragma Export (C, u00192, "ada__real_time__delaysB");
   u00193 : constant Version_32 := 16#0a5c26d7#;
   pragma Export (C, u00193, "ada__real_time__delaysS");
   u00194 : constant Version_32 := 16#fe1ffede#;
   pragma Export (C, u00194, "ada__strings__boundedB");
   u00195 : constant Version_32 := 16#89c18940#;
   pragma Export (C, u00195, "ada__strings__boundedS");
   u00196 : constant Version_32 := 16#7ec26662#;
   pragma Export (C, u00196, "ada__strings__superboundedB");
   u00197 : constant Version_32 := 16#da6addee#;
   pragma Export (C, u00197, "ada__strings__superboundedS");
   u00198 : constant Version_32 := 16#adb6d201#;
   pragma Export (C, u00198, "ada__strings__fixedB");
   u00199 : constant Version_32 := 16#a86b22b3#;
   pragma Export (C, u00199, "ada__strings__fixedS");
   u00200 : constant Version_32 := 16#27d2953a#;
   pragma Export (C, u00200, "ada__strings__unbounded__text_ioB");
   u00201 : constant Version_32 := 16#2e5d93ef#;
   pragma Export (C, u00201, "ada__strings__unbounded__text_ioS");
   ...
   u00206 : constant Version_32 := 16#711f33b9#;
   pragma Export (C, u00206, "pkg_ada_split_stringB");
   u00207 : constant Version_32 := 16#fc4fe989#;
   pragma Export (C, u00207, "pkg_ada_split_stringS");
   u00208 : constant Version_32 := 16#a83b7c85#;
   pragma Export (C, u00208, "system__concat_6B");
   u00209 : constant Version_32 := 16#94f2c1b6#;
   pragma Export (C, u00209, "system__concat_6S");
   ...
   u00212 : constant Version_32 := 16#932a4690#;
   pragma Export (C, u00212, "system__concat_4B");
   u00213 : constant Version_32 := 16#3851c724#;
   ...
   --  pkg_ada_dtstamp%s
   --  pkg_ada_dtstamp%b
   --  pkg_ada_split_string%s
   --  pkg_ada_split_string%b
   --  main_ada_string_processing%b
