pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__main_ada_string_processing.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__main_ada_string_processing.adb");
...
package body ada_main is
   ...
   E167 : Short_Integer; pragma Import (Ada, E167, "gnat_E");
   ...
   E169 : Short_Integer; pragma Import (Ada, E169, "gnat__string_split_E");
   E171 : Short_Integer; pragma Import (Ada, E171, "pkg_ada_dtstamp_E");
   E207 : Short_Integer; pragma Import (Ada, E207, "pkg_ada_split_string_E");
   ...
   begin
      declare
         procedure F1;
         pragma Import (Ada, F1, "pkg_ada_split_string__finalize_body");
      begin
         E207 := E207 - 1;
         F1;
      end;
   ...
   begin
      ...
      E171 := E171 + 1;
      pkg_ada_split_string'elab_body;
      E207 := E207 + 1;
   end adainit;

   procedure Ada_Main_Program;
   pragma Import (Ada, Ada_Main_Program, "_ada_main_ada_string_processing");
...
--  BEGIN Object file/option list
   --   /home/wruslan/github-ump/ada-string-processing/obj/pkg_ada_dtstamp.o
   --   /home/wruslan/github-ump/ada-string-processing/obj/pkg_ada_split_string.o
   --   /home/wruslan/github-ump/ada-string-processing/obj/main_ada_string_processing.o
   --   -L/home/wruslan/github-ump/ada-string-processing/obj/
   --   -L/home/wruslan/github-ump/ada-string-processing/obj/
