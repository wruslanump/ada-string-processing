pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__main_ada_strings_tests.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__main_ada_strings_tests.adb");
...
package body ada_main is
   ...
   E207 : Short_Integer; pragma Import (Ada, E207, "pkg_string_split_E");
   ...
   begin
      declare
         procedure F1;
         pragma Import (Ada, F1, "pkg_string_split__finalize_body");
      begin
         E207 := E207 - 1;
         F1;
      end;
   ...
   begin
      ...
      E171 := E171 + 1;
      pkg_string_split'elab_body;
      E207 := E207 + 1;
   end adainit;

   procedure Ada_Main_Program;
   pragma Import (Ada, Ada_Main_Program, "_ada_main_ada_strings_tests");
...
--  BEGIN Object file/option list
   --   /home/wruslan/github-tests/ada-strings-tests/obj/pkg_ada_dtstamp.o
   --   /home/wruslan/github-tests/ada-strings-tests/obj/pkg_string_split.o
   --   /home/wruslan/github-tests/ada-strings-tests/obj/main_ada_strings_tests.o
   --   -L/home/wruslan/github-tests/ada-strings-tests/obj/
   --   -L/home/wruslan/github-tests/ada-strings-tests/obj/
